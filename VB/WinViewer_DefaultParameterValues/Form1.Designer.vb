Namespace WinViewer_DefaultParameterValues
	Partial Public Class Form1
		...
		Private Sub InitializeComponent()
			...
			Me.dashboardViewer1.DashboardSource = "WinViewer_DefaultParameterValues.Dashboard1"
			Me.dashboardViewer1.Dock = System.Windows.Forms.DockStyle.Fill
			Me.dashboardViewer1.Location = New System.Drawing.Point(0, 0)
			Me.dashboardViewer1.Name = "dashboardViewer1"
			Me.dashboardViewer1.Size = New System.Drawing.Size(808, 523)
...
'INSTANT VB NOTE: The following InitializeComponent event wireup was converted to a 'Handles' clause:
'ORIGINAL LINE: this.dashboardViewer1.ConfigureDataConnection += new DevExpress.DashboardCommon.DashboardConfigureDataConnectionEventHandler(this.dashboardViewer1_ConfigureDataConnection);
			' 
			' Form1
			' 
